...
Erwartet werden 20 erfolgreiche Unit-Tests. Die Repository-Prüfung kontrolliert Datensatz- und Exportprüfsummen, 300 direkte Event-4104-Texte, 300 Managerbelege, 88 Regelalarme, alle Konfusionsmatrizen, die Prüfsummen der vier Methodendiagramme und sämtliche Abbildungsverweise.
...
## 9. Ergebnisdiagramme erzeugen

Die datenabhängigen Ergebnisdiagramme werden aus den eingefrorenen Messergebnissen erzeugt:
...
Das Skript erzeugt <code>threshold_tradeoff.pdf</code>, <code>obfuscation_recall.pdf</code> und <code>bootstrap_confidence_intervals.pdf</code>. <code>baseline_comparison.pdf</code> und <code>lexical_runtime.pdf</code> entstehen durch die in Abschnitt 8 genannten Programme.

Die vier eigenen Methodendiagramme <code>lab_architecture.pdf</code>, <code>dataset_construction.pdf</code>, <code>experiment_flow.pdf</code> und <code>windows_event_channel_evidence.pdf</code> sind als geprüfte statische Vektorgrafiken versioniert. Das Skript überschreibt sie nicht. Ihre Prüfsummen werden durch <code>scripts/verify_repository.py</code> und <code>SHA256SUMS.txt</code> kontrolliert.
